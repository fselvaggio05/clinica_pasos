        ...
        <form class="container" action="AltaUsuarioServlet">
            ...
            <div class="row">
                <div class="d-flex justify-content-end col-8">
                    <button type="button" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Ingreso datos adicionales</button>
                    <!-- si es un profesional, se habilita otra pantalla para ingresar numero de matricula y horarios -->
                ...
                <div class="col-1">
                    <button type="submit" class="btn btn-outline-success btn-sm">Cancelar</button>
                </div>
