...
<div class="d-flex justify-content-end">
    <form class="container" action="AltaUsuarioServlet" method="post">
        ...
        <div class="row">
            <div class="d-flex justify-content-end col-8">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabelPac">Obra social</h5>
                ...
                <button type="button" class="btn btn-outline-success btn-sm m-2" data-bs-toggle="modal" data-bs-target="#exampleModalProf" data-bs-whatever="@prof">Datos Profesional </button>
